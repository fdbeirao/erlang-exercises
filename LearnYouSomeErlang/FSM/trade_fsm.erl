...
%% player also declared being ready, the trade is done
ready(OwnPid) ->
...
%% Courtesy function allowing us to warn the other FSM
%% that we have cancelled the trade
...
wait(not_yet, S=#state{}) ->
  notice(S, "other player not ready yet", []),
  {next_state, wait, S};
wait('ready!', S=#state{}) ->
  am_ready(S#state.other),
